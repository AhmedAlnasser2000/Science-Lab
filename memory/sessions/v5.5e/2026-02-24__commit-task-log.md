...
|---|---|---|---|---|---|---|---|---|---|---|
| v5.5e-task-001 | memory recap capture | active | `docs(V5.5e): save thorough V5.5d recap and explicit d9 memory milestone` | TBD | none | none | n/a | n/a | `memory/canon/verbatim_ledger.md`, `memory/canon/INDEX.md`, `memory/INDEX.md` | entry tail check + index counters |
